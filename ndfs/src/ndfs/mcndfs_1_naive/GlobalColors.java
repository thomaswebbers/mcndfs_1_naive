...
public class GlobalColors {
    ...
    private final Map<State, Integer> countMap ;
    private final Map<State, Boolean> redMap; //if State is in here, it is red
    ...
    GlobalColors() {
        countMap = new HashMap<State, Integer>();
        redMap = new HashMap<State, Boolean>();
        hasResult = false;
        result = false;
    }
